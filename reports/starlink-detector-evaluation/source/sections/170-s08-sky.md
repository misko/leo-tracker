...
between every pair of the eight tunings, on {{s08_published_units}} units in every cell ({{s08_paired_sweeps}}
paired sweeps x {{s08_published_receivers}} live receivers). Axis order was declared in advance — ch1
