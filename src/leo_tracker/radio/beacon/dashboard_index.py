...
def capture_radio_parameters(manifest: dict) -> dict:
    ...
    return {
        ...
        "hardware": {
            ...
            "hardware_model_variant": identity.get("hardware_model_variant"),
            "firmware_version": identity.get("firmware_version"),
            "kernel_version": identity.get("kernel_version"),
            "usb_product": identity.get("usb_product"),
            "ad9361_model": identity.get("ad9361_model"),
            "xo_correction_hz": identity.get("xo_correction_hz"),
            "context_uri": identity.get("context_uri"),
