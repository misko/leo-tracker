...
</style></head><body><main><a href="/">← All recordings</a><h1 id="title">Recording statistics</h1><div id="subtitle" class="muted">loading…</div><section class="panel"><h2>Capture summary</h2><table><tbody id="summary"></tbody></table></section><section id="radiopanel" class="panel"><h2>Radio parameters</h2><div class="muted" style="margin-bottom:12px">Configured settings and hardware readback saved with this capture.</div><div id="radio" class="radio-grid"></div></section><section id="dopplerpanel" class="panel"><h2>Doppler and predicted-pass matching</h2><div id="doppler"></div></section><section id="detectorpanel" class="panel"><h2>Dual-receiver detector and decode evidence</h2><div id="detector"></div></section><section id="fingerprintpanel" class="panel"><h2>Temporal QPSK fingerprint</h2><div class="muted" style="margin-bottom:12px">Frame-by-frame soft probabilities for the known pilot and SSS states. This compares waveform evidence and confidence; it is not decoded user payload or a satellite identity by itself.</div><div id="fingerprintplot" class="plots"></div></section><section id="artifactpanel" class="panel"><h2>Structured artifacts</h2><div id="artifacts"></div></section><section id="plotpanel" class="panel"><h2>Raw signal and analysis plots</h2><div id="plots" class="plots"></div></section><details class="panel"><summary>Complete statistics JSON</summary><pre id="raw"></pre></details></main><script>
const esc=v=>String(v??'—').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
